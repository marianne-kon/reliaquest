...
This Spring Boot application mocks employeeController data to facilitate implementation of required endpoints in API module.
...
Each invocation of **Server** application triggers a new list of mock employeeController data. While testing, you'll want to keep
